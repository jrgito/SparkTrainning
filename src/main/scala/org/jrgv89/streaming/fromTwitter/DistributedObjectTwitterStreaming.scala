...
/**
  ...
  */
object DistributedObjectTwitterStreaming extends App with Constants {

  /* spark configuration */

  val sparkConf = new SparkConf()
    .setMaster(DEFAULT_MASTER)
    .setAppName("DistributedObjectTwitterStreaming")
    ...
    .foreachRDD(
      (rdd) => {
        rdd
          ...
          .saveAsObjectFile("logs/twitter/distributedObject.txt")
      }
    )
